package cn.fulugame.core.config;

import cn.fulugame.core.properties.MultipleDatabaseProperties;
...
@MapperScan(basePackages = {"cn.fulugame.core.dao"}, sqlSessionFactoryRef = "playAdminDbSqlSessionFactory")
